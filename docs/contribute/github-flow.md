<!-- Space: Projects -->
<!-- Parent: KindCalico -->
<!-- Title: Contributing GithubFlow KindCalico -->
<!-- Label: KindCalico -->
<!-- Label: Project -->
<!-- Label: Contributing -->
<!-- Label: GithubFlow -->
...
To contribute to kind-calico project on [GitHub](https://github.com/hadenlabs/kind-calico), We use [GitHub Flow](https://githubflow.github.io/), it means that you should branch from the main repository and contribute back by making [pull request](https://github.com/hadenlabs/kind-calico/pulls).
...
To follow the instructions in this guide and start contributing to kind-calico project on GitHub:
...
```bash
git remote add upstream  https://github.com/hadenlabs/kind-calico.git
```

Now your **upstream** points to **hadenlabs/kind-calico**.
...
git fetch upstream # assuming upstream is hadenlabs/kind-calico
...
All merge requests are automatically tested using [Github Actions](https://github.com/hadenlabs/kind-calico/actions). In case some tests fail, fix the issues or describe why the fix cannot be done.
